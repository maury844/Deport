...
public class MatchesActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listaPartidos.setOnTouchListener(new View.OnTouchListener() {
        ...
        String[] cars = {"Dodge Charger", "BMW", "Toyota", "NO ENTIENDO QUE PASA"};
        ...
        setListViewHeightBasedOnChildren(listaPartidos);
